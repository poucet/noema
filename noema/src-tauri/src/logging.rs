            ...
            match file {
                Ok(file) => {
                    ...
                    let filter = EnvFilter::try_from_default_env()
                        .unwrap_or_else(|_| EnvFilter::new("info,noema_ui_lib=debug,simply_core=info,noema_mcp_gdocs=debug,streaming=debug"));
...
fn init_stderr_logging() {
    let filter = EnvFilter::try_from_default_env()
        .unwrap_or_else(|_| EnvFilter::new("info,noema_ui_lib=debug,simply_core=debug,noema_mcp_gdocs=debug,streaming=debug"));
