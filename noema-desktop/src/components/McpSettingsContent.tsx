                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div
                      className={`w-3 h-3 rounded-full ${
                        server.isConnected ? "bg-teal-500" : "bg-gray-500"
                      }`}
                    />
                    <div>
                      ...
                      <p className="text-sm text-muted">{server.url}</p>
                    </div>
                  </div>
        ...
        <div className="border border-gray-700 rounded-lg p-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted">
              Authentication will be auto-detected. If the server requires
              OAuth, you'll be prompted to login after adding it.
            </p>
...
function OAuthCodeEntry({
  ...
  return (
    <div className="p-4 border border-teal-800 bg-teal-900/20 rounded-lg">
      <h4 className="font-medium text-foreground mb-2">
        Waiting for OAuth Login
      </h4>
      <p className="text-sm text-muted mb-3">
        A browser window should have opened for authentication. After
        authorizing, the app will automatically complete the login. If it
        doesn't work, you can paste the code manually:
      </p>
